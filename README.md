...
| PARALLELISM                  | yes      | None                      | Number of workflows that can run in parallel                                                                                                      |
...
| RATE_BURST                   | yes      | None                      | Burst QPS before the RATE_LIMIT is enforced                                                                                                       |
| RATE_LIMIT                   | yes      | None                      | Limit Queries per Seconds (QPS) enforced at the controller                                                                                        |
...
| WF_TTL_SECONDS_AFTER_SUCCESS | yes      | None                      | Seconds to keep a Workflow CR in the cluster before archiving after success                                                                       |
| WF_TTL_SECONDS_AFTER_FAILURE | yes      | None                      | Seconds to keep a Workflow CR in the cluster before archiving after failure                                                                       |
